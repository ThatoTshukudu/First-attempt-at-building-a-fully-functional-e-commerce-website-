...
<div>
	<div class="form-container sign-in-container">
		...
		<form action="processSignup.php" method="post">
			...
			<button style="background-color:orange;color:black">Sign Up</button>
		</form>
	</div>
	<div class="overlay-container">
		<div  style="background-color:black;"class="overlay">
			...
			<img src="images/kkm.png" width="200" height="200">
				...
				<p style="color:orange">To keep connected with us please login with your personal info</p>
				<a href="login.php"> 
				<button style="background-color:white;color:black" class="ghost" id="signUp">Sign In</button>
				</a>
			</div>
		</div>
	</div>
